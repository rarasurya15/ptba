...
<body>
	<header>			
		...
		<span class="sign"><a class="act" <a href="/Login">Login</a></span>
		<span class="sign"><a href="/FAQsOut">FAQs</a></span>
		<span class="sign"><a href="/ProgramOut">Program</a></span>
		<span class="sign"><a href="/Beranda">Beranda</a></span>
	</header>
    ...
    <div class="slider">
		...
		<div class="myslide fade">
			...
			<img src="banner18.jpg" style="width: 100%; height: 100%;">
		</div>
		...
		<div class="myslide fade">
			...
			<img src="banner19.jpg" style="width: 100%; height: 100%;">
		</div>
		...
		<div class="myslide fade">
			...
			<img src="banner15.jpg" style="width: 100%; height: 100%;">
		</div>
    ...
    <div class="content1">
      <div class="content">
        ...
        <p> Syarat dan ketentuan <br>
			...
			3. Mendapatkan rekomendasi untuk mengikuti Program magang, kerja peraktik atau peraktek kerja lapangan<br>
			4. Mendapatkan persetujuan Kaprodi dan Verifikasi Pimpinan PT pada platform Kampus Merdeka<br>
			5. Berkomitmen untuk melaksanakan dan menyelesaikan Program magang, kerja peraktik atau peraktek kerja lapangan<br>
			</p>
    </div>
  </section>
	...
	<div class="row">
		<div class="col">
			...
			Kantor Pusat
				...
				Sumatera Selatan, Indonesia 31716
				</p>
			<p>Kantor Perwakilan Jakarta Menara Kadin Indonesia Lt. 15<br>
			Jl. HR. Rasuna Said Blok X-5, Kav 2-3 Jakarta 12950</p>
		</div>
		<div class="col">
        <h2><a href="/Beranda">Beranda </a></h2>
        <h2><a href="/Program">Program</a></h2>
        <h2><a href="/Profil">Profil</a></h2>
        <h2><a href="/Daftar">Daftar</a></h2>
        <h2><a href="/StatusPendaftaran">Status</a></h2>
